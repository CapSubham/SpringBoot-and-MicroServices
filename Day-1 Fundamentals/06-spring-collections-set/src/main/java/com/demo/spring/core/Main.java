...
public class Main {
	...
	public static void main(String[] args) {
		ApplicationContext applicationContext = new ClassPathXmlApplicationContext("hospital-beans.xml");
		...
		Set<String> hospitalDept = hospital.getHospitalDepartments();
		...
		Set<String> deptartmentList = department.getDepartmentNames();
